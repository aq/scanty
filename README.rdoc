...
Set via heroku cli the application credientials:

  heroku config:add SMALL123_PASSWORD='password' --app myappstaging
  heroku config:add SMALL123_COOKIE_VALUE='123456789' --app myappstaging
